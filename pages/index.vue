            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6">
              <nav class="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
                ...
                <div class="hidden md:flex md:space-x-10">
                  ...
                  <a href="#blob" class="font-medium text-gray-500 hover:text-gray-900">Blob</a>
                  <a href="#v2g" class="font-medium text-gray-500 hover:text-gray-900">V2G</a>
                  <a href="#contact" class="font-medium text-gray-500 hover:text-gray-900">Nous contacter</a>
            ...
            <div class="lg:grid lg:grid-cols-12">
              ...
              <div class="relative bg-indigo-600 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
                <div class="absolute inset-0 hidden overflow-hidden rounded-3xl lg:block" aria-hidden="true">
                  <svg id="blob" class="absolute bottom-full left-full translate-y-1/3 -translate-x-2/3 transform xl:bottom-auto xl:top-0 xl:translate-y-0" width="404" height="384" fill="none" viewBox="0 0 404 384" aria-hidden="true">
                    <defs>
...
if __name__ == "__main__":
    main()
      ...
      <div class="bg-indigo-600">
        <div class="mx-auto max-w-5xl py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          ...
          <div class="mt-8 grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-4">
            <div class="col-span-1 flex justify-center items-center md:col-span-2 lg:col-span-1">
              <img class="h-12" src="../static/rgb-text-white-row@2048.png" alt="Tuple">
            </div>
            <div class="col-span-1 flex justify-center items-center md:col-span-2 lg:col-span-1">
              <p class="text-2xl mb-1 text-gray-300 font-bold">FTarget</p>
            </div>
            <div class="col-span-1 flex justify-center items-center md:col-span-2 lg:col-span-1">
              <img class="h-8 mb-3" src="../static/SpaceX_Logo_Black.png" alt="Tuple">
            </div>
            <div class="col-span-1 flex justify-center items-center md:col-span-2 lg:col-span-1">
              <img class="h-12" src="../static/logo.png" alt="Tuple">
              <p class="ml-2 text-2xl text-gray-300 font-bold">OPTI. Inc</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5">
        <div class="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
          <div class="mx-auto max-w-lg">
            <h2 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Contacter nous !</h2>
            <p class="mt-3 text-lg leading-6 text-gray-500">Pour toutes questions, n'hésitez pas à venir nous parler.</p>
            <dl class="mt-8 text-base text-gray-500">
              <div>
                <dt class="sr-only">Postal address</dt>
                <dd>
                  <p>16 Bd Général de Gaulle</p>
                  <p>Nantes, 44200</p>
                </dd>
              </div>
              <div class="mt-6">
                ...
                <dd class="flex">
                  ...
                  <span class="ml-3">02 40 76 60 87</span>
                </dd>
              </div>
              <div class="mt-3">
                ...
                <dd class="flex">
                  ...
                  <span class="ml-3">info@nantes-epsi.fr</span>
                </dd>
              </div>
            </dl>
          </div>
        ...
        <div class="bg-white py-16 px-4 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12">
          <div class="mx-auto max-w-lg lg:max-w-none">
            <form action="#" method="POST" class="grid grid-cols-1 gap-y-6">
              <div>
                <label for="full-name" class="sr-only">Nom prénom</label>
              ...
              <div>
                <button type="submit" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-3 px-6 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Envoyer</button>
              </div>
            </form>
          </div>
        </div>
    ...
    <footer class="bg-white">
      <div class="mx-auto max-w-7xl overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
        <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
          ...
          <div class="px-5 py-2">
            <a href="#blob" class="text-base text-gray-500 hover:text-gray-900">Blob</a>
          </div>

          <div class="px-5 py-2">
            <a href="#v2g" class="text-base text-gray-500 hover:text-gray-900">V2G</a>
          </div>

          <div class="px-5 py-2">
            <a href="#contact" class="text-base text-gray-500 hover:text-gray-900">Nous contacter</a>
          </div>

        </nav>
        <div class="mt-8 flex justify-center space-x-6">
          <a href="mailto:info@nantes-epsi.fr" class="text-gray-400 hover:text-gray-500">
        ...
        <p class="mt-8 text-center text-base text-gray-400">&copy; 2022 optiblob, Inc. Tout droit réservé.</p>
      </div>
    </footer>
  </div>
</template>
